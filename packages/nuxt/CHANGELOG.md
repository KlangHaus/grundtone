...
- Updated dependencies
  ...
  - @grundtone/design-system@3.2.2
  - @grundtone/icons@3.2.2
  - @grundtone/utils@3.2.2
  - @grundtone/vue@3.2.2
...
- [#205](https://github.com/KlangHaus/grundtone/pull/205)
  ...
  Thanks [@allanasp](https://github.com/allanasp)! - The module now also injects
  `@grundtone/design-system/fonts.css`, so Nuxt apps load the self-hosted IBM Plex fonts without any
  configuration.

### Patch Changes

- [#206](https://github.com/KlangHaus/grundtone/pull/206)
  [`c7baa0b`](https://github.com/KlangHaus/grundtone/commit/c7baa0b2e00b156a53c47ff49778f5e0fa1c2d52)
  Thanks [@allanasp](https://github.com/allanasp)! - **Components and composables are registered
  from `@grundtone/vue` itself, not from its `src/` folder.** Two measured defects came out of the
  old directory scan:

  - `@grundtone/vue` publishes only `dist` and `scss` (3.1.0 ships 0 `src` files; 2.23.3 shipped
    255), so `../../vue/src/...` does not exist in an installed package.
